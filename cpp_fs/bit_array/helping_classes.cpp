...
#include "helping_classes.hpp"

namespace ilrd
{
size_t CountOnBitsInElement::operator()(size_t init, const unsigned char byte_)
{
    static const size_t COUNT_LUT[256] = 
    {
    ...
    return (init + COUNT_LUT[byte_]);
}

/******************************************************************************/
std::string& ConvertElementToString::operator()(std::string& init, 
                                                    const unsigned char byte_)
{
    static const char STRINGS_OF_BYTE[256][9] = 
    {
    ...
    init.insert(0, STRINGS_OF_BYTE[byte_]);
